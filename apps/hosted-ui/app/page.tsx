...
import rubyEscrow, { RubyEscrowSDK } from "@ruby-escrow/sdk";
...
export default function Home() {
  ...
  const handleInit = async () => {
    try {
      setDemoLoading(true);
      await rubyEscrow.configure({
        apiKey: "your_api_key_here",
        baseUrl: "https://your-hosted-ui.com",
        environment: "sandbox",
      });
      setDemoStatus({ type: "success", message: "SDK initialized" });
      console.log("success");
  ...
  const handleDemo = async (
    ...
    try {
      ...
      if (sdkReady) {
        ...
        const baseOptions = {
          customerId: "69f9477ad0822094e4466720",
          displayMode,
          ...(displayMode === "inline"
            ? { container: "#inlineEscrowContainer" }
            : {}),
        ...
        const options = isTransaction
          ? {
            ...baseOptions,
            participantId: "69f9f3b66e1aa9c1a7136499",
            isSeller: true,
            amount: 10000,
            currency: "USD",
            name: "Demo Purchase",
      ...
      <main className="bg-gray-950 text-white">
        ...
        <section className="bg-gradient-to-b from-gray-900 to-gray-950 py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-400 mb-8 max-w-2xl mx-auto">
              A lightweight TypeScript SDK that wraps Payluk's
              escrow-as-a-service with two powerful methods:{" "}
              <span className="font-mono text-green-400">create</span> and{" "}
              <span className="font-mono text-green-400">init</span>. Integrate
              in minutes, go live instantly.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-green-500 transition-colors">
                ...
                <p className="text-gray-400">
                  Built on Payluk's trusted escrow infrastructure. Your funds
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-green-500 transition-colors">
                ...
                <p className="text-gray-400">
                  Minimal integration points: just configure once and call{" "}
                  <span className="font-mono">init()</span> when needed.
                </p>
              </div>
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-green-500 transition-colors">
                ...
                <p className="text-gray-400">
                  Modal, fullscreen, or inline. Choose how the widget fits into
                  your UX.
                </p>
              </div>
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-green-500 transition-colors">
                ...
                <p className="text-gray-400">
                  Pass participant and transaction details upfront. Auto-fill
                  forms and streamline UX.
                </p>
              </div>
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-green-500 transition-colors">
                ...
                <p className="text-gray-400">
                  Test in sandbox mode first. Switch to production with a single
                  config change.
                </p>
              </div>
            </div>
        ...
        >
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-gray-400 mb-12">
              Copy and paste these snippets to get started. See our docs for
              more advanced usage.
            </p>
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <p className="text-gray-400 mb-4">
                  Open the wallet for a customer with just their ID. Perfect for
                  accessing transaction history and managing funds.
                </p>
              ...
              <div>
                <h3 className="text-2xl font-semibold mb-4 flex items-center gap-2">
                  <span className="text-green-400">4.</span> Pre-Seeded
                  Transaction
                </h3>
                <p className="text-gray-400 mb-4">
                  Create a transaction with pre-filled data. Participant name
                  and email are locked (read-only), but transaction details
                  remain editable.
                </p>
              ...
              <div>
                ...
                <p className="text-gray-400 mb-4">
                  Embed the escrow widget directly into your page instead of
                  using a modal or fullscreen overlay.
                </p>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 border-t border-gray-800">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-green-500 transition-colors">
                  ...
                  <button
                    onClick={() =>
                      handleDemo("Wallet Fullscreen", "fullscreen", false)
                    }
                    disabled={demoLoading || !sdkReady}
                    className="w-full px-4 py-2 bg-green-600 hover:bg-green-700 disabled:bg-gray-700 disabled:cursor-not-allowed rounded font-semibold text-sm transition-all"
                  >
            ...
            {/*inline display*/}
            <div className="no-scrollbar" id="inlineEscrowContainer"></div>
            ...
            <div className="mb-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-green-500 transition-colors">
                  ...
                  <button
                    onClick={() =>
                      handleDemo("Transaction Modal", "modal", true)
                    }
                    disabled={demoLoading || !sdkReady}
                    className="w-full px-4 py-2 bg-green-600 hover:bg-green-700 disabled:bg-gray-700 disabled:cursor-not-allowed rounded font-semibold text-sm transition-all"
                  >
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-green-500 transition-colors">
                  ...
                  <button
                    onClick={() =>
                      handleDemo("Transaction Fullscreen", "fullscreen", true)
                    }
                    disabled={demoLoading || !sdkReady}
                    className="w-full px-4 py-2 bg-green-600 hover:bg-green-700 disabled:bg-gray-700 disabled:cursor-not-allowed rounded font-semibold text-sm transition-all"
                  >
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-green-500 transition-colors">
                  ...
                  <button
                    onClick={() =>
                      handleDemo("Transaction Inline", "inline", true)
                    }
                    disabled={demoLoading || !sdkReady}
                    className="w-full px-4 py-2 bg-green-600 hover:bg-green-700 disabled:bg-gray-700 disabled:cursor-not-allowed rounded font-semibold text-sm transition-all"
                  >
            ...
            {demoStatus && (
              <div
                className={`mt-6 p-4 rounded-lg border flex items-center gap-3 ${demoStatus.type === "success"
            ...
            <div className="mt-8 p-4 bg-gray-900 border border-gray-800 rounded-lg">
              <p className="text-sm text-gray-400">
                <strong>Note:</strong> The demo buttons require the SDK bundle
                to be available at{" "}
                <span className="font-mono text-green-400">
                  /dist/index.global.js
                </span>
                . For production use, install via npm and import as a module.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 border-t border-gray-800">
          <div className="max-w-4xl mx-auto text-center bg-gradient-to-r from-green-900/20 to-blue-900/20 border border-green-500/30 rounded-lg p-12">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Start integrating ruby-escrow-js into your application today and
              offer seamless escrow transactions to your users.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
