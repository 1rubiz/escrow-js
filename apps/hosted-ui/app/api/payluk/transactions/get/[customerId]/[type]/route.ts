...
import { getTransactions } from '@/lib/paylukClient';
...
export async function GET(
    request: NextRequest,
    { params }: { params: { customerId: string, type: string } }
) {
    try {
        // Validate API key
        ...
        // Call Payluk API
        const result = await getTransactions(customerId, type as "sales" | "buy" | undefined);
